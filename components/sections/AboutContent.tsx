      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-4">
          <a
            ...
            className="flex items-center gap-4 p-4 bg-[var(--surface)] border border-[var(--border-color)] rounded-[var(--radius-md)] hover:border-[var(--color-brand-purple)]/50 hover:-translate-y-1 hover:shadow-[var(--shadow-md)] transition-all duration-[var(--transition-base)]"
          >
            ...
            <div>
              ...
              <p className="text-[var(--text-muted)] text-[var(--font-size-caption)]">github.com/beanteacher</p>
            </div>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 p-4 bg-[var(--surface)] border border-[var(--border-color)] rounded-[var(--radius-md)] hover:border-[var(--color-brand-blue)]/50 hover:-translate-y-1 hover:shadow-[var(--shadow-md)] transition-all duration-[var(--transition-base)]"
          >
            <span className="text-2xl">
            ...
            <div>
              ...
              <p className="text-[var(--text-muted)] text-[var(--font-size-caption)]">velog.io/@mings</p>
            </div>
          </a>
          ...
          {email && (
            <a
              href={`mailto:${email}`}
              className="flex items-center gap-4 p-4 bg-[var(--surface)] border border-[var(--border-color)] rounded-[var(--radius-md)] hover:border-[var(--color-brand-cyan)]/50 hover:-translate-y-1 hover:shadow-[var(--shadow-md)] transition-all duration-[var(--transition-base)]"
            >
              <span className="text-2xl">
