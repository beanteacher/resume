...
export async function GET() {
  try {
    const companies = await prisma.company.findMany({ include: { projects: { include: { codeSnippets: { orderBy: { sortOrder: 'asc' } } }, orderBy: [{ startDate: { sort: 'desc', nulls: 'last' } }, { createdAt: 'desc' }] } }, orderBy: { startDate: 'desc' } })
